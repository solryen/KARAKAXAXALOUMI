      ...
      <PageShell>
        <div className="site-header-inner">
          ...
          <StoreButton location="header-cta">
            <span className="desktop-label">Download App</span>
            <span className="mobile-label">Download App</span>
          </StoreButton>
        </div>
      </PageShell>
    </header>
...
function FeatureIcon({ type }) {
  const paths = {
    ...
    'Baby Tracker':
      'M10.8 5.7c-1.2 0-2.2.8-2.6 2-.2-.1-.5-.1-.7-.1-1.5 0-2.7 1.2-2.7 2.7 0 .8.3 1.5.8 2-.3.4-.4.9-.4 1.4 0 1.6 1.3 2.9 2.9 2.9.4 0 .8-.1 1.2-.2.5.9 1.4 1.5 2.5 1.5V5.7zm2.4 0c1.2 0 2.2.8 2.6 2 .2-.1.5-.1.7-.1 1.5 0 2.7 1.2 2.7 2.7 0 .8-.3 1.5-.8 2 .3.4.4.9.4 1.4 0 1.6-1.3 2.9-2.9 2.9-.4 0-.8-.1-1.2-.2-.5.9-1.4 1.5-2.5 1.5V5.7zm-1.2 0V18m-1.9-8.1c0-.7-.5-1.2-1.2-1.2m1.2 5c0-.7-.5-1.2-1.2-1.2m3.8-2.6c0-.7.5-1.2 1.2-1.2m-1.2 5c0-.7.5-1.2 1.2-1.2m-1.9-.1h1.1',
    'Milestone Chapters':
      'M6 6.8h4.7c1.3 0 2.5.5 3.3 1.4.8-.9 2-1.4 3.3-1.4H18v10h-.7c-1.6 0-3 .6-3.9 1.7-.9-1.1-2.3-1.7-3.9-1.7H6zm6.7 1.3v10.5m-4.1-7.7h2m3.7 0H16m-7.4 2.6h2m3.7 0H16',
    'Bedtime Stories':
